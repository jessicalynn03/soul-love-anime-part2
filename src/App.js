...
// An array of objects with the name and cover image of the anime that is displayed on the home screen. 
...
function App() {
  //useState is used to pass through the objects in the array. 
  const [animeToShow, setAnimeToShow] = useState({});
  return (
    <div className="App">
    {/* What is being dislayed of each page as the user is being rerouting upon clicking on the navs or anime cover/title. */}
      <Header />
      <Routes>
